...
internal static class CalendarsEndpoints
{
    public static IEndpointRouteBuilder MapCalendarsEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        group.MapGet("/", async (HttpContext http, FamilyCloudDbContext db) =>
        {
        ...
        group.MapGet("/{calendarId:guid}/events", async (
            Guid calendarId, HttpContext http, FamilyCloudDbContext db, DateTimeOffset? start, DateTimeOffset? end) =>
        {
            var userId = http.User.GetUserId();
        ...
        group.MapPost("/{calendarId:guid}/events", async (
            Guid calendarId, EventWriteRequest request, HttpContext http, FamilyCloudDbContext db,
        ...
        eventsGroup.MapPut("/{eventId:guid}", async (
            Guid eventId, EventWriteRequest request, HttpContext http, FamilyCloudDbContext db,
            ICalDavPasswordProtector passwordProtector, CalendarWriteService writeService) =>
        {
            var userId = http.User.GetUserId();
        ...
        eventsGroup.MapDelete("/{eventId:guid}", async (
            Guid eventId, HttpContext http, FamilyCloudDbContext db,
            ICalDavPasswordProtector passwordProtector, CalendarWriteService writeService) =>
        {
            var userId = http.User.GetUserId();
            var existing = await db.CachedEvents
    ...
    private static EventDto ToDto(FamilyCloud.Core.Domain.CachedEvent e) =>
