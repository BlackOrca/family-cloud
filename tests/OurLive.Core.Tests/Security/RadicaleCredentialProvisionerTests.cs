...
namespace OurLive.Core.Tests.Security;

public class RadicaleCredentialProvisionerTests : IDisposable
{
    private readonly string tempDirectory = Path.Combine(Path.GetTempPath(), "ourlive-radicale-provisioner-tests", Guid.NewGuid().ToString("N"));
